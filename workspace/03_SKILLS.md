...
| S4   | `read-content-queue` | Read Content Queue | Auto | Low | Read an eligible Twitter/X post row from Google Sheets. |
| S5   | `publish-twitter-post` | Publish Twitter Post | Auto | Low | Publish eligible queued content to Twitter/X. |
| S6   | `update-content-queue` | Update Content Queue | Auto | Low | Write published tweet metadata back to Google Sheets. |
